...
وكمان مخرجات 18 تشغيلة بـgreedy decoding عبر Q4 وQ6 وQ8 تطابقت بايت ببايت. [عقد التنفيذ](v04-execution-contract.md) يسجل القرار، والمسار المرجعي لسه متاح. أما `planned-fused` فبقي خيار تشغله بنفسك، لأن فرق سرعته عن `planned` كان برضه داخل ضوضاء القياس.
